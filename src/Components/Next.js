  ...
  return (
    <>
      <div style={{marginLeft:500}}>
        ...
        <h2 style={{marginLeft:150}}>Choice of Food: </h2>
        ...
        <Link to="/"><button style={{marginLeft:200}}>BACK</button></Link>
              ...
              <div className="form-group">
                <form>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setnewFormData({ ...newFormData, food: e.target.value })
                    }
                  />{" "}
                  Italian
                  <br />
